(() => {
  ...
  var HoverWindow = ({ className, model, hoverPrefab, _L }) => {
    ...
    const metaContent = /* @__PURE__ */ import_react.default.createElement("div", { className: "mt-4 fs-sm" }, /* @__PURE__ */ import_react.default.createElement(Grid, { auto: true }, /* @__PURE__ */ import_react.default.createElement("div", null, hoverPrefab.Meta.XPReward ? /* @__PURE__ */ import_react.default.createElement("div", { className: "d-flex flex-row justify-content-center bg-section-light rounded p-1" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "text-light mr-1" }, formatNumber(hoverPrefab.Meta.XPReward)), /* @__PURE__ */ import_react.default.createElement("span", { className: "text-muted" }, "XP")) : null), /* @__PURE__ */ import_react.default.createElement("div", null), /* @__PURE__ */ import_react.default.createElement("div", null)));
    ...
    const titleContent = /* @__PURE__ */ import_react.default.createElement("div", { className: "d-flex flex-row align-items-center justify-content-start fs-normal" }, /* @__PURE__ */ import_react.default.createElement(Icon, { className: "mr-2 ml-2", icon: modalTypeIconSrc, fa: modalTypeIconIsFAIcon ? true : null }), /* @__PURE__ */ import_react.default.createElement("span", { className: "flex-1 mr-2" }, prefabName(hoverPrefab)), hoverPrefab.Meta.Cost ? /* @__PURE__ */ import_react.default.createElement("span", { className: "ml-x" }, /* @__PURE__ */ import_react.default.createElement("span", { className: "text-success mr-2" }, "\xA2", formatNumber(hoverPrefab.Meta.Cost)), /* @__PURE__ */ import_react.default.createElement(Icon, { className: "bg-success mr-2", icon: "money", mask: true })) : null);
    return /* @__PURE__ */ import_react.default.createElement(Modal, { className, title: titleContent, noClose: true }, renderHoverContents());
  };
  ...
  var PrefabItem = ({ model, trigger, prefab, selected, _L, onSelected, onMouseEnter, onMouseLeave, extraContent }) => {
    ...
    const highlightSearchTerm = (text) => {
      if (!model.Search || model.Search.trim().length === 0)
        return text;
      const words = model.Search.trim().split(/\s+/).map(
        (word) => word.replace(/[.*+?^${}()|[\]\\]/g, "\\$&")
      );
      const regex = new RegExp(`(${words.join("|")})`, "gi");
      const splitText = text.split(regex);
      return splitText.map(
        (part, index) => regex.test(part) ? /* @__PURE__ */ import_react4.default.createElement("span", { key: index, className: selected.Name === prefab.Name ? "text-dark bg-warning" : "text-dark bg-warning" }, /* @__PURE__ */ import_react4.default.createElement("b", null, part)) : part
      );
    };
